          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <p><strong>Обработка персональных данных</strong> — любые действия с персональными данными: сбор, хранение, использование, передачу, удаление и др.</p>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>аналитика использования сайта и улучшение качествa обслуживания.</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>12.1. Использование Сайтa означает согласие Пользователя с данной Политикой.</p>
